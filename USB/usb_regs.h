...
#define EPREG_MASK \
    (EP_CTR_RX | EP_SETUP | EP_T_FIELD | EP_KIND | EP_CTR_TX | EPADDR_FIELD)
...
#define _SetEP_KIND(bEpNum) \
    (_SetENDPOINT(bEpNum, (_GetENDPOINT(bEpNum) | EP_KIND) & EPREG_MASK))
#define _ClearEP_KIND(bEpNum) \
    (_SetENDPOINT(bEpNum, (_GetENDPOINT(bEpNum) & EPKIND_MASK)))
...
#define _ClearDTOG_RX(bEpNum) \
    if((_GetENDPOINT(bEpNum) & EP_DTOG_RX) != 0) _ToggleDTOG_RX(bEpNum)
#define _ClearDTOG_TX(bEpNum) \
    if((_GetENDPOINT(bEpNum) & EP_DTOG_TX) != 0) _ToggleDTOG_TX(bEpNum)
/*******************************************************************************
...
#define _SetEPAddress(bEpNum, bAddr) \
    _SetENDPOINT(bEpNum, _GetENDPOINT(bEpNum) & EPREG_MASK | bAddr)
...
#define _pEPTxCount(bEpNum) \
    ((u32*)((_GetBTABLE() + bEpNum * 8 + 2) * 2 + PMAAddr))
#define _pEPRxAddr(bEpNum) \
    ((u32*)((_GetBTABLE() + bEpNum * 8 + 4) * 2 + PMAAddr))
#define _pEPRxCount(bEpNum) \
    ((u32*)((_GetBTABLE() + bEpNum * 8 + 6) * 2 + PMAAddr))

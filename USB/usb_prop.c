...
USER_STANDARD_REQUESTS User_Standard_Requests = { Mass_Storage_GetConfiguration,
...
ONE_DESCRIPTOR Device_Descriptor = { (u8*)MASS_DeviceDescriptor,
    MASS_SIZ_DEVICE_DESC };

ONE_DESCRIPTOR Config_Descriptor = { (u8*)MASS_ConfigDescriptor,
